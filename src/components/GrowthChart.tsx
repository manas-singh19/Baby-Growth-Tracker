...
export default function GrowthChart({ measurements, gender, type, unit }: GrowthChartProps) {
    ...
    if (measurementData.length > 0) {
        ...
        const babyDataPoints = p50Data.map(point => {
    ...
    const chartData = {
        ...
        datasets: datasets.length > 0 ? datasets : [{ data: [0], color: () => colors.chartPercentile50 }],
    };
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.legend}>
                ...
                <Text style={styles.legendNote}>
                    Tap on measurements below to see detailed information
                </Text>
            </View>
            ...
            {measurementData.length > 0 && (
                <View style={styles.measurementsList}>
                    ...
                    {measurements.slice(-5).reverse().map((m) => {
                        const value = type === 'weight' ? m.weightKg : type === 'height' ? m.heightCm : m.headCm;
                        const percentile = type === 'weight' ? m.weightPercentile : type === 'height' ? m.heightPercentile : m.headPercentile;
