...
import { getTodayISO, isValidMeasurementDate, formatDate } from '../utils/dateUtils';
...
export default function MeasurementForm({
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            // Convert to SI units
            const weightKg = weightUnit === 'kg' ? parseFloat(data.weight) : lbToKg(parseFloat(data.weight));
            const heightCm = lengthUnit === 'cm' ? parseFloat(data.height) : inToCm(parseFloat(data.height));
                ...
                >
                    {loading ? (
                        ...
                        <Text style={styles.submitButtonText}>
                            {existingMeasurement ? 'Update' : 'Save'}
                        </Text>
                    )}
                </TouchableOpacity>
            </View>
